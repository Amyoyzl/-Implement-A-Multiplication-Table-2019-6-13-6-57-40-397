...
it('should return null when invoke getMultipicationTable given start small than 0', () => {
    // given
    const start = -2;
    const end = 2;
    // when
...
it('should return null when invoke getMultipicationTable given end large than 1000', () => {
    // given
    const start = -2;
    const end = 1020;
    // when
